...
void BitcoinGUI::createActions()
{
    ...
    blockAction = new QAction(QIcon(":/icons/block"), tr("&Block Browser"), this);
...
//    tabGroup->addAction(radioAction);
	...
	nodeAction = new QAction(QIcon(":/icons/address-book"), tr("&Node Info"), this);
...
//    connect(radioAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Pentaquark"), this);
    aboutAction->setToolTip(tr("Show information about Pentaquark"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/qtlogo-64"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Pentaquark"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Pentaquark client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Pentaquark client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pentaquark network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Pentaquark address or malformed URI parameters."));
    }

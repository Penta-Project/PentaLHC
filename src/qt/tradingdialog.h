...
private slots:
    ...
    void on_BuyPENTAQUARK_clicked();
    void on_SellPENTAQUARKBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputPENTAQUARK_textChanged(const QString &arg1);
    ...
    QString BuyPENTAQUARK(QString OrderType, double Quantity, double Rate);
    QString SellPENTAQUARK(QString OrderType, double Quantity, double Rate);

...
!define URL http://www.pentaquark.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/pentaquark.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\pentaquark-qt.exe
...
OutFile pentaquark-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/pentaquark-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/pentaquarkd.exe
    ...
    #Delete /REBOOTOK $INSTDIR\pentaquark.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\pentaquark-qt.exe
